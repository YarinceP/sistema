                        ...
                        <form method="post" action="" id="form_nuevo">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="codigo_pk" id="codigo_pk" required maxlength="255"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="descripcion" id="" required maxlength="255"
                                           class="form-control"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="sku_proveedor" id="nombre" required maxlength="255"
                                           class="form-control"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="costo_fijo" id="" required step="any"
                                           class="form-control"/>
                                </div>

                                <div class="col-sm-6">
                                    <label class='control-sidebar-subheading' for="fecha">Costo Variable</label>
                                    <input type="number" name="costo_variable" id="" required step="any"
                                           class="form-control"/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="utilidad" id="" required step="any"
                                           class="form-control"/>
                                </div>
