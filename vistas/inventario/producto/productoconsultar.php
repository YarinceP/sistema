                        ...
                        <form method="post" action="" id="form_eliminar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="descripcion" id="" value="<?php echo $descripcion ?>"
                                           maxlength="255" class="form-control" required readonly/>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="categoria_fk" name="categoria_fk" readonly="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="marca_fk" name="marca_fk" readonly>
                                ...
                                <div class="col-sm-6">
                                    <label class='control-sidebar-subheading' for="fecha">Familias</label>
                                    <select class="form-control" id="impuesto_fk" name="impuesto_fk" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <label class='control-sidebar-subheading' for="fecha">Familias</label>
                                    <select class="form-control" id="unidades_fk" name="unidades_fk" readonly="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="costo_fijo" id="" value="<?php echo $costo_fijo ?>"
                                           step="any" class="form-control" required readonly/>
                                </div>
